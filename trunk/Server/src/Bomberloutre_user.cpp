...
::Ice::Object* ::Bomberloutre::upCast(::Bomberloutre::UserConnection* p) { return p; }
::IceProxy::Ice::Object* IceProxy::Bomberloutre::upCast(::IceProxy::Bomberloutre::UserConnection* p) { return p; }

::Ice::Object* ::Bomberloutre::upCast(::Bomberloutre::User* p) { return p; }
::IceProxy::Ice::Object* IceProxy::Bomberloutre::upCast(::IceProxy::Bomberloutre::User* p) { return p; }
...
Bomberloutre::User::__write(::IceInternal::BasicStream* __os) const
{
    ...
    __os->write(nbSuicide);
    __os->write(gameTag);
    __os->write(::Ice::ObjectPrx(::IceProxy::Bomberloutre::upCast(mgr.get())));
    __os->endWriteSlice();
#if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
    Object::__write(__os);
#else
