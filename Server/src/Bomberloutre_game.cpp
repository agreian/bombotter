...
::Ice::Object* ::Bomberloutre::upCast(::Bomberloutre::GameWaitRoom* p) { return p; }
::IceProxy::Ice::Object* IceProxy::Bomberloutre::upCast(::IceProxy::Bomberloutre::GameWaitRoom* p) { return p; }

::Ice::Object* ::Bomberloutre::upCast(::Bomberloutre::Game* p) { return p; }
::IceProxy::Ice::Object* IceProxy::Bomberloutre::upCast(::IceProxy::Bomberloutre::Game* p) { return p; }

::Ice::Object* ::Bomberloutre::upCast(::Bomberloutre::GamesManager* p) { return p; }
::IceProxy::Ice::Object* IceProxy::Bomberloutre::upCast(::IceProxy::Bomberloutre::GamesManager* p) { return p; }
...
Bomberloutre::__writeRoomList(::IceInternal::BasicStream* __os, const ::Bomberloutre::GameWaitRoomPrx* begin, const ::Bomberloutre::GameWaitRoomPrx* end)
{
    ...
    {
        __os->write(::Ice::ObjectPrx(::IceProxy::Bomberloutre::upCast(begin[i].get())));
    }
}
...
IceProxy::Bomberloutre::GamesManager::begin_createGame(const ::std::string& name, const ::Bomberloutre::GameWaitRoomPrx& room, const ::Ice::Context* __ctx, const ::IceInternal::CallbackBasePtr& __del, const ::Ice::LocalObjectPtr& __cookie)
{
    ...
    try
    {
        ...
        ::IceInternal::BasicStream* __os = __result->__getOs();
        __os->write(name);
        __os->write(::Ice::ObjectPrx(::IceProxy::Bomberloutre::upCast(room.get())));
        __os->endWriteEncaps();
        __result->__send(true);
    }
    catch(const ::Ice::LocalException& __ex)
...
IceProxy::Bomberloutre::GamesManager::begin_joinGame(const ::std::string& name, const ::Bomberloutre::GameWaitRoomPrx& room, const ::Bomberloutre::MapObserverPrx& mo, const ::Ice::Context* __ctx, const ::IceInternal::CallbackBasePtr& __del, const ::Ice::LocalObjectPtr& __cookie)
{
    ...
    try
    {
        ...
        __os->write(name);
        __os->write(::Ice::ObjectPrx(::IceProxy::Bomberloutre::upCast(room.get())));
        __os->write(::Ice::ObjectPrx(::IceProxy::Bomberloutre::upCast(mo.get())));
        __os->endWriteEncaps();
        __result->__send(true);
    }
    catch(const ::Ice::LocalException& __ex)
...
Bomberloutre::Game::__gcReachable(::IceInternal::GCCountMap& _c) const
{
    if(currentMap)
    {
        ::Bomberloutre::upCast(currentMap.get())->__addObject(_c);
    }
}
...
Bomberloutre::Game::__gcClear()
{
    if(currentMap)
    {
        if(::Bomberloutre::upCast(currentMap.get())->__usesClasses())
        {
            ::Bomberloutre::upCast(currentMap.get())->__decRefUnsafe();
...
Bomberloutre::Game::__write(::IceInternal::BasicStream* __os) const
{
    ...
    __os->write(::Ice::ObjectPtr(::Bomberloutre::upCast(currentMap.get())));
    __os->endWriteSlice();
#if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
    Object::__write(__os);
#else
...
Bomberloutre::GamesManager::___createGame(::IceInternal::Incoming& __inS, const ::Ice::Current& __current)
{
    ...
    __os->write(::Ice::ObjectPtr(::Bomberloutre::upCast(__ret.get())));
    __os->writePendingObjects();
    return ::Ice::DispatchOK;
}
