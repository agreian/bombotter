...
::Ice::Object* ::Bomberloutre::upCast(::Bomberloutre::Map* p) { return p; }
::IceProxy::Ice::Object* IceProxy::Bomberloutre::upCast(::IceProxy::Bomberloutre::Map* p) { return p; }

::Ice::Object* ::Bomberloutre::upCast(::Bomberloutre::MapClassic* p) { return p; }
::IceProxy::Ice::Object* IceProxy::Bomberloutre::upCast(::IceProxy::Bomberloutre::MapClassic* p) { return p; }

::Ice::Object* ::Bomberloutre::upCast(::Bomberloutre::MapSurvival* p) { return p; }
::IceProxy::Ice::Object* IceProxy::Bomberloutre::upCast(::IceProxy::Bomberloutre::MapSurvival* p) { return p; }

::Ice::Object* ::Bomberloutre::upCast(::Bomberloutre::MapFogOfWar* p) { return p; }
::IceProxy::Ice::Object* IceProxy::Bomberloutre::upCast(::IceProxy::Bomberloutre::MapFogOfWar* p) { return p; }

::Ice::Object* ::Bomberloutre::upCast(::Bomberloutre::MapObserver* p) { return p; }
::IceProxy::Ice::Object* IceProxy::Bomberloutre::upCast(::IceProxy::Bomberloutre::MapObserver* p) { return p; }
...
IceProxy::Bomberloutre::Map::begin_checkMove(const ::Bomberloutre::PlayerPtr& p, const ::Bomberloutre::Point& pt, const ::Ice::Context* __ctx, const ::IceInternal::CallbackBasePtr& __del, const ::Ice::LocalObjectPtr& __cookie)
{
    ...
    try
    {
        ...
        ::IceInternal::BasicStream* __os = __result->__getOs();
        __os->write(::Ice::ObjectPtr(::Bomberloutre::upCast(p.get())));
        pt.__write(__os);
...
IceProxy::Bomberloutre::MapObserver::begin_refreshAll(const ::Bomberloutre::MapPtr& m, const ::Ice::Context* __ctx, const ::IceInternal::CallbackBasePtr& __del, const ::Ice::LocalObjectPtr& __cookie)
{
    ...
    try
    {
        ...
        ::IceInternal::BasicStream* __os = __result->__getOs();
        __os->write(::Ice::ObjectPtr(::Bomberloutre::upCast(m.get())));
        __os->writePendingObjects();
        __os->endWriteEncaps();
        __result->__send(true);
    }
...
IceProxy::Bomberloutre::MapObserver::begin_bombHasBeenPlanted(const ::Bomberloutre::BombPtr& b, const ::Ice::Context* __ctx, const ::IceInternal::CallbackBasePtr& __del, const ::Ice::LocalObjectPtr& __cookie)
{
    ...
    try
    {
        ...
        ::IceInternal::BasicStream* __os = __result->__getOs();
        __os->write(::Ice::ObjectPtr(::Bomberloutre::upCast(b.get())));
        __os->writePendingObjects();
        __os->endWriteEncaps();
        __result->__send(true);
    }
...
{
    {
        for(::Bomberloutre::MapItems::const_iterator _i0 = items.begin(); _i0 != items.end(); ++_i0)
        {
            if((*_i0))
            {
                ::Bomberloutre::upCast((*_i0).get())->__addObject(_c);
            }
        }
    }
    {
...
{
    {
        for(::Bomberloutre::MapItems::iterator _i0 = items.begin(); _i0 != items.end(); ++_i0)
        {
            if((*_i0))
            {
                if(::Bomberloutre::upCast((*_i0).get())->__usesClasses())
                {
                    ::Bomberloutre::upCast((*_i0).get())->__decRefUnsafe();
